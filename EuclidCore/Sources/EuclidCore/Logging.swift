...
/// Shared helper for creating consistent os.Logger instances across the Euclid app and EuclidCore.
public enum EuclidLog {
  public static let subsystem = "com.jjeremycai.Euclid"
